...
if (_firstTime) then
{
	_object = [_controlGroup, "sb"] joinString "_";
	[
		missionNamespace getVariable [_object, objNull],
		_controlGroup
...
[_controller, [_popupToggleText, {
	[(_this select 0), (_this select 1)] remoteExec ["wsot_fnc_toggleTargetPopups", 2, false];
